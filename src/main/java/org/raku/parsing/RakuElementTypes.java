...
public interface RakuElementTypes {
    IStubFileElementType FILE = new RakuFileElementType();
    IStubElementType PACKAGE_DECLARATION = new RakuPackageDeclStubElementType();
    IStubElementType ROUTINE_DECLARATION = new RakuRoutineDeclStubElementType();
    IStubElementType ENUM = new RakuEnumStubElementType();
    IStubElementType SUBSET = new RakuSubsetStubElementType();
    IStubElementType CONSTANT = new RakuConstantStubElementType();
    IStubElementType REGEX_DECLARATION = new RakuRegexDeclStubElementType();
    IStubElementType VARIABLE_DECLARATION = new RakuVariableDeclStubElementType();
    IStubElementType SCOPED_DECLARATION = new RakuScopedDeclStubElementType();
    IStubElementType USE_STATEMENT = new RakuUseStatementStubElementType();
    IStubElementType NEED_STATEMENT = new RakuNeedStatementStubElementType();
    IStubElementType TYPE_NAME = new RakuTypeNameStubElementType();
    IStubElementType TRAIT = new RakuTraitStubElementType();
    IStubElementType SUB_CALL = new RakuSubCallStubElementType();
