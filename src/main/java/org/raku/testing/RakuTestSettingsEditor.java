...
public class RakuTestSettingsEditor extends SettingsEditor<RakuTestRunConfiguration> {
    ...
    public RakuTestSettingsEditor(Project project) {
        myProject = project;
    }

    @Override
    protected void resetEditorFrom(@NotNull RakuTestRunConfiguration configuration) {
        // Specific options
    ...
    @Override
    protected void applyEditorTo(@NotNull RakuTestRunConfiguration configuration) throws ConfigurationException {
        // Specific options
