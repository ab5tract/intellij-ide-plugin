...
import static edument.rakuidea.parsing.RakuElementTypes.SEMI_LIST;
        ...
        rules.add((left, right) -> {
            ...
            if (blockoid.getElementType() == RakuElementTypes.BLOCKOID) {
                PsiElement source = PsiTreeUtil.getParentOfType(blockoid.getPsi(), RakuPackageDecl.class,
                                                                ...
                                                                RakuBlockOrHash.class, edument.rakuidea.psi.RakuBlock.class);
                ...
                if (statementCount == 0) {
                    if (source instanceof RakuPackageDecl && customSettings.PACKAGE_DECLARATION_IN_ONE_LINE ||
                        ...
                        (source instanceof RakuStatement ||
                         ...
                         source instanceof edument.rakuidea.psi.RakuBlock) && commonSettings.KEEP_SIMPLE_BLOCKS_IN_ONE_LINE) {
