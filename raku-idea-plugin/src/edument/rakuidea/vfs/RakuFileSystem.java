...
public class RakuFileSystem extends ArchiveFileSystem {
    ...
    @NotNull
    @Override
    protected RakuFileHandler getHandler(@NotNull VirtualFile file) {
        return VfsImplUtil.getHandler(this, file, RakuFileHandler::new);
    }
    ...
    public VirtualFile findLocalByRootPath(@NotNull String rootPath) {
        ...
        return new RakuLightVirtualFile(localPath, "");
    }
