...
public class RakuVariableImpl extends ASTWrapperPsiElement implements RakuVariable {
    ...
    public String getVariableName() {
        ...
        if (varToken == null) {
            if (findChildByType(edument.rakuidea.parsing.RakuTokenTypes.REGEX_CAPTURE_NAME) != null) {
                return getText();
            } else {
                return null;
            }
    ...
    public boolean isCaptureVariable() {
        return getNode().findChildByType(edument.rakuidea.parsing.RakuTokenTypes.REGEX_CAPTURE_NAME) != null;
    }
