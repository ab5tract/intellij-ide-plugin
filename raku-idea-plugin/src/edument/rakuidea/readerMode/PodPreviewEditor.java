package edument.rakuidea.readerMode;
...
import edument.rakuidea.editor.podPreview.HtmlStringResourceHandler;
import edument.rakuidea.editor.podPreview.NoContentResourceHandler;
...
public class PodPreviewEditor extends UserDataHolderBase implements FileEditor {
    ...
    private final RakuModuleViewEditor moduleViewEditor;
    ...
    public PodPreviewEditor(Project project,
                            ...
                            EditorImpl editor, RakuModuleViewEditor moduleViewEditor) {
        ...
        htmlPanel.getJBCefClient().setProperty(JBCefClient.Properties.JS_QUERY_POOL_SIZE, 256);
    ...
    public String getModeChangeHandlers() {
        ...
        if (myCodeModeQuery == null) {
            ...
            myCodeModeQuery.addHandler((ignore) -> {
                moduleViewEditor.updateState(RakuReaderModeState.CODE);
                return null;
            });
        }
        if (mySplitModeQuery == null) {
            ...
            mySplitModeQuery.addHandler((ignore) -> {
                moduleViewEditor.updateState(RakuReaderModeState.SPLIT);
                return null;
            });
        }
        if (myDocModeQuery == null) {
            ...
            myDocModeQuery.addHandler((ignore) -> {
                moduleViewEditor.updateState(RakuReaderModeState.DOCS);
                return null;
            });
        }
        return
