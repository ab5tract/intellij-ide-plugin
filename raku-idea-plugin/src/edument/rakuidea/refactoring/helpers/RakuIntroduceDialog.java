package edument.rakuidea.refactoring.helpers;
...
import edument.rakuidea.refactoring.RakuNameValidator;
...
public class RakuIntroduceDialog extends DialogWrapper {
    ...
    public RakuIntroduceDialog(Project project,
                               String title,
    ...
    private void setUpNameComboBox(Collection<String> names) {
        EditorComboBoxEditor comboBoxEditor = new StringComboboxEditor(myProject, RakuScriptFileType.INSTANCE, myNameComboBox);
    ...
    public boolean isModified(RakuIntroduceDialog data) {
        return false;
    }
