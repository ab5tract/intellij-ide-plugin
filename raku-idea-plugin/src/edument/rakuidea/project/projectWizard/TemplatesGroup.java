...
import edument.rakuidea.project.projectWizard.categories.ProjectCategory;
...
public class TemplatesGroup implements Comparable<TemplatesGroup> {
    ...
    public TemplatesGroup(ModuleBuilder builder) {
        this(builder.getPresentableName(), builder.getDescription(), builder.getNodeIcon(), builder.getWeight(), builder.getParentGroup(),
             builder.getBuilderId(), builder);
    }
