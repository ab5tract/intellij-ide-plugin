...
package edument.rakuidea.project.projectWizard.components;
...
import edument.rakuidea.utils.CommaProjectWizardUtil;
...
public class ModuleNameLocationComponent implements ModuleNameLocationSettings {
    ...
    private void validateExistingModuleName() throws ConfigurationException {
        ...
        final String moduleName = getModuleName();
        final Module module;
        final RakuProjectStructureConfigurable
          fromConfigurable = edument.rakuidea.project.structure.RakuProjectStructureConfigurable.getInstance(project);
