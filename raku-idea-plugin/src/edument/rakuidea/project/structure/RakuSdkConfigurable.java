...
public class RakuSdkConfigurable extends NamedConfigurable<Sdk> implements Place.Navigator {
    private final ProjectJdkImpl myProjectJdk;
    private final RakuSdkEditor mySdkEditor;

    public RakuSdkConfigurable(ProjectJdkImpl projectJdk,
