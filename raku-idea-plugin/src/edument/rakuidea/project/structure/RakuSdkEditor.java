...
public class RakuSdkEditor implements Configurable, Place.Navigator {
    private static final Logger LOG = Logger.getInstance(RakuSdkEditor.class);
    ...
    public RakuSdkEditor(@NotNull Project project,
