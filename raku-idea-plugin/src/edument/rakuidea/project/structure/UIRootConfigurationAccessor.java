...
public class UIRootConfigurationAccessor extends RootConfigurationAccessor {
    ...
    public Library getLibrary(Library library, final String libraryName, final String libraryLevel) {
        ...
        //final RakuStructureConfigurableContext context = RakuProjectStructureConfigurable.getInstance(myProject).getContext();
        //if (library == null) {
        //    if (libraryName != null) {
    ...
    public Sdk getSdk(final Sdk sdk, final String sdkName) {
        // FIXME SDK
        //final ProjectSdksModel model = RakuProjectStructureConfigurable.getInstance(myProject).getSdkConfig().getJdksTreeModel();
    ...
    public Sdk getProjectSdk(final @NotNull Project project) {
        return edument.rakuidea.project.structure.RakuProjectStructureConfigurable.getInstance(project).getProjectSdksModel().getProjectSdk();
    }
    ...
    public String getProjectSdkName(final @NotNull Project project) {
        ...
        final ProjectSdksModel projectJdksModel = edument.rakuidea.project.structure.RakuProjectStructureConfigurable.getInstance(project).getProjectSdksModel();
