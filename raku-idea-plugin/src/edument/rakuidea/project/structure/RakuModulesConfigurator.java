package edument.rakuidea.project.structure;
...
import edument.rakuidea.actions.comma.ImportModuleAction;
import edument.rakuidea.project.projectWizard.CommaAbstractProjectWizard;
import edument.rakuidea.project.projectWizard.CommaNewProjectWizard;
import edument.rakuidea.project.structure.ui.HeaderHidingTabbedModuleEditor;
...
public class RakuModulesConfigurator implements ModulesProvider, ModuleEditor.ChangeListener {
    private static final Logger LOG = Logger.getInstance(RakuModulesConfigurator.class);
    private final Project myProject;
    private ModifiableModuleModel myModuleModel;
    private RakuStructureConfigurableContext myContext;
    ...
    public RakuModulesConfigurator(Project project) {
        myProject = project;
    ...
    private ModuleEditor doCreateModuleEditor(@NotNull Module module) {
        ...
        Disposer.register(moduleEditor, new Disposable() {
            @Override
            public void dispose() {
                moduleEditor.removeChangeListener(RakuModulesConfigurator.this);
            }
        });
        return moduleEditor;
    }
    ...
    public static boolean showDialog(@NotNull Project project, @Nullable final String moduleToSelect, @Nullable final String editorNameToSelect) {
        final RakuProjectStructureConfigurable config = edument.rakuidea.project.structure.RakuProjectStructureConfigurable.getInstance(project);
    ...
    public void apply() throws ConfigurationException {
        ...
        final ProjectSdksModel projectJdksModel = edument.rakuidea.project.structure.RakuProjectStructureConfigurable.getInstance(myProject).getProjectSdksModel();
    ...
    public void setContext(RakuStructureConfigurableContext context) {
        myContext = context;
    }
