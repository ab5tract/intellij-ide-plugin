...
public class OPP {
    ...
    private void reduce() {
        ...
        if (op.fake) {
            ...
            adverbMarker.doneBefore(RakuOPPElementTypes.ADVERB_APPLICATION, here);
            ...
            prefixMarker.doneBefore(RakuOPPElementTypes.PREFIX_APPLICATION, term.endMarker);
            Term composite = new Term();
            ...
            postfixMarker.doneBefore(RakuOPPElementTypes.POSTFIX_APPLICATION, op.endMarker);
            Term composite = new Term();
            ...
            infixMarker.doneBefore(regexMode ? RakuOPPElementTypes.REGEX_INFIX_APPLICATION : RakuOPPElementTypes.INFIX_APPLICATION, right.endMarker);
            Term composite = new Term();
