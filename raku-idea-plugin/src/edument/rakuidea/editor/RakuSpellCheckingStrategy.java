...
public class RakuSpellCheckingStrategy extends SpellcheckingStrategy {
    ...
    public Tokenizer<?> getTokenizer(PsiElement element) {
        if (element.getNode().getElementType() == edument.rakuidea.parsing.RakuTokenTypes.COMMENT ||
            element.getNode().getElementType() == edument.rakuidea.parsing.RakuTokenTypes.POD_FINISH_TEXT ||
