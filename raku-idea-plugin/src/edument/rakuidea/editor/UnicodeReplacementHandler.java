        ...
        if (charMappings != null) {
            ...
            for (Mapping m : charMappings) {
                ...
                if (text.substring(start, offset).equals(m.ascii)) {
                    ...
                    if (curToken == RakuTokenTypes.INFIX) {
                        ...
                        return Result.STOP;
                    } else if (curToken == edument.rakuidea.parsing.RakuTokenTypes.METAOP) {
                        PsiElement el = file.findElementAt(start - 1);
                        RakuHyperMetaOp hyperMeta = PsiTreeUtil.getParentOfType(el, RakuHyperMetaOp.class);
