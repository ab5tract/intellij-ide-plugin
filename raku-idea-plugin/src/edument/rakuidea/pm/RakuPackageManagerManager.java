package edument.rakuidea.pm;

import com.intellij.openapi.components.*;
import com.intellij.openapi.vfs.VirtualFile;
import edument.rakuidea.pm.impl.RakuPakkuPM;
import edument.rakuidea.pm.impl.RakuZefPM;
...
@Service
@State(name = "edument.rakuidea.pm.RakuPackageManagerManager", storages = @Storage(StoragePathMacros.WORKSPACE_FILE))
