...
import edument.rakuidea.annotation.fix.AddUseModuleFix;
...
import edument.rakuidea.utils.RakuConstants;
...
public class ChangePackageTypeIntention extends PsiElementBaseIntentionAction implements IntentionAction {
    ...
    public boolean isAvailable(@NotNull Project project, Editor editor, @NotNull PsiElement element) {
        ...
        if (elementType == RakuTokenTypes.PACKAGE_DECLARATOR)
            return true;
        return elementType == edument.rakuidea.parsing.RakuTokenTypes.PACKAGE_NAME;
    }
