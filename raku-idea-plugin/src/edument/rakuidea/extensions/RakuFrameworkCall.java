package edument.rakuidea.extensions;
...
public abstract class RakuFrameworkCall {
    public static final ExtensionPointName<RakuFrameworkCall> EP_NAME = ExtensionPointName.create("edument.perl6idea.frameworkCall");
