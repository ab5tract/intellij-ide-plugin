 ...
 */
package edument.rakuidea.build.community
...
class CommaCommunityProperties extends CommaPropertiesBase {
  CommaCommunityProperties(BuildDependenciesCommunityRoot communityHome) {
    ...
    applicationInfoModule = "edument.raku.comma.community"
    brandingResourcePaths = List.of(communityHome.communityRoot.resolve("comma-build/complete/resources"))

    productLayout.mainModules = List.of("edument.raku.comma.community")
    productLayout.productApiModules = ["intellij.xml.dom", "edument.raku.comma.community"]
