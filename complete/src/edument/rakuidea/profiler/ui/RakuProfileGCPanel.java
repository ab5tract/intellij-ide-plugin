...
public class RakuProfileGCPanel extends JPanel {
    public RakuProfileGCPanel(RakuProfileData data) {
    ...
    private static class GCTableModel implements TableModel, RakuProfileModelWithRatio {
        List<GCData> gcs;

        private GCTableModel(RakuProfileData data) {
            gcs = data.getGC();
        }
