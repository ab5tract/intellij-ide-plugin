...
public class RakuProfileModulesPanel extends JPanel {
    ...
    public RakuProfileModulesPanel(RakuProfileData data) {
    ...
    private static Map<String, Pair<Integer, Integer>> calculateModulesData(RakuProfileData profileData) {
        try {
