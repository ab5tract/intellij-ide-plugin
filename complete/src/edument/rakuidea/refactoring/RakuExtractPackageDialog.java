...
public class RakuExtractPackageDialog extends ExtractSuperBaseDialog<RakuPackageDecl, RakuAttributeInfo> {
    ...
    protected RakuExtractPackageDialog(@NotNull Project project, RakuPackageDecl aPackage, List<RakuAttributeInfo> members,
