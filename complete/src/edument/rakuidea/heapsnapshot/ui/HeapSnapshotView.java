...
import edument.rakuidea.heapsnapshot.run.RakuLoadHeapSnapshotFileTask;
...
public class HeapSnapshotView extends JPanel {
    ...
    public void updateResultsFromFile(File file) {
        ...
        Task.Backgroundable task = new RakuLoadHeapSnapshotFileTask(myProject, "Processing Heap Snapshots", true, file, this);
